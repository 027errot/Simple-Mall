<template>
  <div>
    ...
    <div>
      ...
      <el-cascader :options="options2" :props="props" clearable></el-cascader>
      <!-- 这里的写成:props="{ multiple: true }"时，就不用写data中的props(直接把下面的数据写上来) -->
    </div>
...
export default {
  data() {
    return {
      ...
      props: { multiple: true, disabled: true, checkStrictly: true },
      options2: [{
        value: 1,
        label: '东南',
        children: [{
